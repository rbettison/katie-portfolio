...
export default function Header() {
    ...
    return (
        ...
        <div className="font-highlightFont text-white bg-gradient-to-b to-thirdBg-100 from-mainBg-100  w-74 flex flex-row drop-shadow-md justify-evenly p-4 text-md border rounded-full border-white mt-8 divide-x">
